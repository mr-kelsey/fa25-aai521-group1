...
# Import unified model manager - require successful import
...
def denoise_image(noisy_img):
    ...
    # Use the new pipeline implementation directly - no fallbacks
...
def apply_enhancements_sequentially(img_path, task_list):
    ...
    for task_type in ordered_tasks:
        # Apply the enhancement to the current image - no fallbacks
